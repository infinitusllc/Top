...
<div class="sideBar">
    <ul>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'tour_form',  'tabcontent2', 'tablinks2')"> ტურის დამატება </a></li>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'translations', 'tabcontent2', 'tablinks2')"> თარგმნა </a></li>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'combinations', 'tabcontent2', 'tablinks2')"> კომბინაციები </a></li>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'generic_page_form', 'tabcontent2', 'tablinks2')"> generic გვერდი </a></li>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'slide_form', 'tabcontent2', 'tablinks2')"> სლაიდის შექმნა </a></li>
        <li class="tablinks2" style="float: left; width: 100%; text-align: center; cursor: pointer"><a class="tablinks2" onclick="openTab(event, 'header_form', 'tabcontent2', 'tablinks2')"> ჰედერის ლინკები </a></li>
    </ul>
</div>
