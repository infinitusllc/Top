...
!function (e) {
    ...
    t.Defaults = {
        ...
        t._core.$element.find("." + t._core.options.datepicker["class"]).on("click", "." + t._core.options.datepicker["class"] + "_next", function () {
            ...
            e(this).closest('form').find('.mfDatePicker').removeClass('open');
